    ...
    <div class="pro-container">
        ...
        ?>
                <form action="" method="post">
                    <div class="pro">
                        <div class="pro-img position-relative" data-bs-toggle="modal" data-bs-target="#<?php echo $modalId; ?>">
                            <img src="Images/<?php echo $fetch_product['image']; ?>" alt="" class="img-fluid">
                            <h4><span class="badge bg-danger position-absolute top-0 end-0 m-2">New</span></h4>
                        </div>
